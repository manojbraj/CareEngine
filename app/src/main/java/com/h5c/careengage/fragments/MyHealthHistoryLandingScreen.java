 ...
 */
public class MyHealthHistoryLandingScreen extends Fragment{
    ...
    public MyHealthHistoryLandingScreen() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        image_one.setImageResource(R.drawable.ico_hospitalization);
        image_two.setImageResource(R.drawable.ico_allergy);
        image_three.setImageResource(R.drawable.ico_testresults);
        text_one.setText("Hospitalization");
        text_two.setText("Allergies");
        text_three.setText("Test Results");
