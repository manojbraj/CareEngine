package com.h5c.careengage.designing.spedometer;
 ...
 */
public class SpedoMeter extends View implements SpeedChangeListener{
    private static final String TAG = SpedoMeter.class.getSimpleName();
    ...
    public SpedoMeter(Context context){
        super(context);
    }

    public SpedoMeter(Context context, AttributeSet attrs) {
        super(context, attrs);
