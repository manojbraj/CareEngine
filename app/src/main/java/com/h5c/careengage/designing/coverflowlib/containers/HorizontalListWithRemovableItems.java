...
import com.h5c.careengage.designing.coverflowlib.containers.interfaces.IRemovableItemsAdapterComponent;
import com.h5c.careengage.designing.coverflowlib.containers.interfaces.IRemoveFromAdapter;
import com.h5c.careengage.designing.coverflowlib.general.ToolBox;
...
//	}
	...
	private Animator createRemoveAnimations(final int removedViewIndex){
		...
		@SuppressLint({"NewApi", "LocalSuppress"}) ObjectAnimator fader = ObjectAnimator.ofFloat(removed, "alpha", 1f, 0f);
