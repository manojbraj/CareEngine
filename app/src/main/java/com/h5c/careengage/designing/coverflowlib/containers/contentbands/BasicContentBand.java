package com.h5c.careengage.designing.coverflowlib.containers.contentbands;
...
//    private final Rect mTempRect = new Rect();
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(mAdapter != null){
        	...
        	com.h5c.careengage.designing.coverflowlib.general.Validate.isTrue(mDspHeight > 0, "Adapter getBottom must return value greater than zero");
        }
        else{
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
            	...
            	if(mHandleSelectionOnActionUp && mTouchState == TOUCH_STATE_RESTING){
            		final float d = com.h5c.careengage.designing.coverflowlib.general.ToolBox.getLineLength(mDown.x, mDown.y, x, y);
...
//----------------CONTENT BAND END--------------------------------------------------------------------
	...
	public static abstract class AbstractAdapter <V extends View, Tile extends com.h5c.careengage.designing.coverflowlib.containers.contentbands.TileBase> implements Adapter{
...
//		protected SparseArray<Tile> mTilesByNumber;
		...
		public View[] getViewsVisibleInRange(int from, int to){
			...
			ArrayList<Tile> union = com.h5c.careengage.designing.coverflowlib.general.ToolBox.union(listLeft, listRight);
