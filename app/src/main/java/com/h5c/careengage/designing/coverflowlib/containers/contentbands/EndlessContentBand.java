 ...
 */
public class EndlessContentBand extends com.h5c.careengage.designing.coverflowlib.containers.contentbands.BasicContentBand {
	...
	protected void refillLeftSide(){
		...
		if(dspModuloLeftScreenEdge > dspModuloNextViewsRight){
			...
			list = com.h5c.careengage.designing.coverflowlib.general.ToolBox.concatenateArray(list1, list2);
		}
		else{
